...
function executePythonScript(data) {
    return new Promise((resolve, reject) => {
        const pythonProcess = spawn('python', ['E:/amazon sambhav/mcf omniflux/backend_vania/inventory_lead_time/furniture_inventory_data/predict.py', JSON.stringify(data)]);
...
async function main() {
    try {
        const inputData = [
            { "Lead time": 4, "Manufacturing lead time": 18 } // Ensure only expected features are included
        ];
