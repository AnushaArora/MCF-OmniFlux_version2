...
function executePythonScript(data) {
    return new Promise((resolve, reject) => {
        const pythonProcess = spawn('python', ['E:/amazon sambhav/mcf omniflux/backend_vania/inventory_lead_time/stationary_data_model/predict.py', JSON.stringify(data)]);
...
async function main() {
    try {
        const inputData = [
            { "Lead time": 10, "Manufacturing lead time": 27 } // Ensure only expected features are included
        ];
