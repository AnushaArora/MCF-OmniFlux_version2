...
function executePythonScript(data) {
    return new Promise((resolve, reject) => {
        const pythonProcess = spawn('python', ['E:/amazon sambhav/mcf omniflux/backend_vania/inventory_lead_time/accessories_data_model/predict.py', JSON.stringify(data)]);
...
async function main() {
    try {
        const inputData = [
            { "Lead time": 20, "Manufacturing lead time": 21 } // Ensure only expected features are included
        ];
